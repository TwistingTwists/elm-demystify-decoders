...
import Json.Decode exposing (Decoder, decodeString, fail, list, map, string, succeed)
...
decoder =
    ...
    -- list (map String.toUpper string)
    -- second implementation
    list (string |> Json.Decode.andThen (\x -> x |> String.toUpper |> succeed))
