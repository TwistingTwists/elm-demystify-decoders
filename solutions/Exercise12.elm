...
import Json.Decode exposing (Decoder, andThen, fail, field, int, lazy, list, map2, oneOf, string, succeed)
...
decoder =
    oneOf
        [ map2 Branch (field "name" string) (field "children" (list (lazy (\_ -> decoder))))
